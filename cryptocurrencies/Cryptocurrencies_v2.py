...
def main():
    ...
    currencies_labels_tickers = np.array(
        [['Bitcoin Cash', 'BCH'], ['Bitcoin', 'BTC'], ['BitConnect', 'BCC'], ['Dash', 'DASH'],
         ['Etherium Classic', 'ETC'], ['Etherium', 'ETH'], ['Iota', 'MIOTA'], ['Litecoin', 'LTC'],
    ...
    currencies = pd.concat([bitcoin_cash, bitcoin, bitconnect, dash, etherium_classic, etherium, iota,
    ...
    # and the highest current market caps according to https://coinmarketcap.com/.
    print("Heatmap showing absent values:")
    sns.heatmap(pd.isnull(prices))

    currencies_labels_tickers_to_remove = np.array(
        [['Bitcoin Cash', 'BCH'], ['BitConnect', 'BCC'], ['Etherium Classic', 'ETC'],
